/* Using the Credential Management API - Wrapper Code, Alan Dean
...
namespace SecureCredentialsLibrary
{
  ...
  public sealed class CredentialsDialog
  {
    ...
    public System.Net.NetworkCredential NetworkCredentials
    {
      get
      {
        ...
        CREDUI.ReturnCodes returnCode = CREDUI.CredUIParseUserName( this._name, userBuilder, int.MaxValue, domainBuilder, int.MaxValue );
        switch( returnCode )
        {
          case CREDUI.ReturnCodes.NO_ERROR:
            return new System.Net.NetworkCredential( userBuilder.ToString(), this._password, domainBuilder.ToString() );

          case CREDUI.ReturnCodes.ERROR_INVALID_ACCOUNT_NAME:
            return new System.Net.NetworkCredential( this._name, this._password );
  ...
  public sealed class CREDUI
  {
    ...
    public static extern ReturnCodes CredUIParseUserName(
        string userName,
        StringBuilder user,
        int userMaxChars,
